...
$sql2 = " SELECT * FROM media where type='صورة' ";
	try {
...
<div class="container-fluid pt-3" style="margin-top:4%;margin-bottom:8%">
    <div class="container animate-box" data-animate-effect="fadeIn">
        <div class="panel panel-default">
							<div class="panel-heading">
								<h2 class="sub-title" 
                            style="font-weight:normal;border-right: 6px solid #FFD700;"> الصفحة الرئيسية / الصور</h2>
							</div>
						</div>
		...
		?>
            ...
            <div class="item px-2">
                <div class="fh5co_latest_trading_img_position_relative">
                    <div class="fh5co_news_img"><img style="height: 100%;
    min-width: 100%;max-width: 100%;" src="<?php echo $res['lien'] ?> " alt=""  /></div>
                    <div class="fh5co_latest_trading_img_position_absolute_1">
                        <div class="panel panel-default">
							<div class="panel-heading">
								<h2 class="sub-title" id="titre"> <?php echo $res['titre'] ?></h2>
							</div>
