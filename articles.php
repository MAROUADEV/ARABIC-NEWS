...
<head>
    ...
    <title>MaghrebEco — <?php echo $categorieReq ?></title>
	...
	<div class="col-md-12">
						...
						<div class="panel panel-default">
							 <div class="panel-heading">
								<h2 class="sub-title" 
                            style="font-weight:normal;border-right: 6px solid #FFD700;"> الصفحة الرئيسية / <?php echo $categorieReq ?></h2>
							</div>
						</div>
					</div>
    ...
    <script type="text/javascript">
      ...
      function displayRecords(lim, off) {
        $.ajax({
          type: "GET",
          async: false,
          url: "get-articles.php?categories=<?php echo $categories ?>",
