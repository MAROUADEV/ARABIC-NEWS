                ...
                <div class="row">
                        ...
                        <div class="card">
                            ...
                            <div class="content">
                                ...
                                <div class="footer">
                                    ...
                                    <hr>
                                    <div class="stats">
                                        <i class="fa fa-clock-o"></i>Posted <script>document.write(new Date().getFullYear())</script>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="card">
                            ...
                            <div class="content">
                                <div id="chartPreferences" class="ct-chart ct-perfect-fourth">
                                    <canvas id="cnv" style="height:100%;width:100%"></canvas>
                                </div>
...
<!--   Core JS Files   -->
	...
	<script type="text/javascript">
    	$(document).ready(function(){
        	...
        	$.notify({
            	icon: 'pe-7s-gift',
            	message: "Bienvenue <b><?php echo $_SESSION['Nom'] ?> 😊  </b>.. Heureux de vous voir ici 😉"
