...
if (isset($_POST['titre']) && isset($_POST['contenu'])) {
				...
				if($width>=300 && $height>=200){
					$sql2 = " INSERT INTO `articles` (`id_article`, `titre`, `contenu`,`fichier`, `date`,`categories`,count) VALUES (NULL, '".$titre."', '".$contenu."','".$fichier."',DATE_ADD(NOW(), INTERVAL 1 MINUTE),'".$categories."','0')";
						try {
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h4 class="title" style="float:right">كتابة مقال جديد</h4>
                            </div>
                            <div class="content">
							     ...
							     <?php if(isset($msg)) echo $msg;  ?>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 pull-right" >
						                  ...
						                  <textarea placeholder="المحتوى" name="contenu" id="contenu" class="form-control" rows="5" style="direction:RTL;" ></textarea>
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 pull-right" >
                                            ...
                                            <input type="text" id="fichier" name="fichier" placeholder="الرابط" class="form-control" style="direction:RTL;" >
                                        </div>
