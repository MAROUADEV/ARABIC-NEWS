...
<div class="content" dir="rtl" style="background-color:#f0f0f0">
		...
		<table id="example"  class="table table-striped table-bordered table-hover">
			...
			<?php
				...
				$query=mysqli_query($conn,"select * from `media`");
				while($row=mysqli_fetch_array($query)){
					...
					<tr>
						...
						<td>
							<a href="#edit<?php echo $row['id_media']; ?>" data-toggle="modal" class="btn btn-warning"><span class="fa fa-pencil-square-o" aria-hidden="true"></span> </a>  
							<a href="#del<?php echo $row['id_media']; ?>" data-toggle="modal" class="btn btn-danger"><span class="fa fa-times" aria-hidden="true"></span> </a>
							<?php include('button-media.php'); ?>
						</td>
					</tr>
					<?php
				}
